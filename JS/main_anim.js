function App() {
    ...
    function initScene() {
        ...
        scene.background=new THREE.Color( 0x010536 );
        let pointLight1 = new THREE.PointLight(0xfff200);
        pointLight1.position.set(-wWidth / 2, wHeight / 2, 50);
        scene.add(pointLight1);

        let pointLight2 = new THREE.PointLight(0x00b548);
        pointLight2.position.set(wWidth / 2, wHeight / 2, 50);
        scene.add(pointLight2);

        let pointLight3 = new THREE.PointLight(0x003cff);
        pointLight3.position.set(-wWidth / 2, -wHeight / 2, 50);
        scene.add(pointLight3);

        let pointLight4 = new THREE.PointLight(0xff6200);
